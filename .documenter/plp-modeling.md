...
![](public/train_test_splitting.png)


## Training Models with MLJ.jl {#Training-Models-with-MLJ.jl}
...
## Full Pipeline Summary {#Full-Pipeline-Summary}
...
- Reps, J. M., et al. (2018). Design and implementation of a standardized framework to generate and evaluate patient-level prediction models using observational healthcare data. _JAMIA_, 25(8), 969–975. https://doi.org/10.1093/jamia/ocy032
