...
## Initialize a Study with HealthBase.jl {#Initialize-a-Study-with-HealthBase.jl}
...
## Download Cohort Definitions with OHDSIAPI.jl {#Download-Cohort-Definitions-with-OHDSIAPI.jl}
...
## Translate Cohort JSON to SQL with OHDSICohortExpressions.jl {#Translate-Cohort-JSON-to-SQL-with-OHDSICohortExpressions.jl}
...
## Run SQL Against OMOP CDM with FunSQL.jl and DBInterface.jl {#Run-SQL-Against-OMOP-CDM-with-FunSQL.jl-and-DBInterface.jl}
