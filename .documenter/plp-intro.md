...
# Observational Health &amp; Patient-Level Prediction {#Observational-Health-and-Patient-Level-Prediction}

## What is Observational Health Research? {#What-is-Observational-Health-Research?}
...
## Why Phenotypes Matter {#Why-Phenotypes-Matter}
...
## The OMOP Common Data Model {#The-OMOP-Common-Data-Model}
...
Patient-Level Prediction (PLP) asks a specific kind of question: _for this individual patient, how likely is it that a particular event will occur in the future?_
...
3. **Index date** - each patient&#39;s cohort entry date; features are extracted _before_ this date, outcomes are labeled _after_
...
> 
> Reps, J. M., Schuemie, M. J., Suchard, M. A., Ryan, P. B., Rijnbeek, P. R., &amp; Madigan, D. (2018). Design and implementation of a standardized framework to generate and evaluate patient-level prediction models using observational healthcare data. _JAMIA_, 25(8), 969–975. https://doi.org/10.1093/jamia/ocy032
> 
